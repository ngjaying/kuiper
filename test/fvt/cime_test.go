...
func (s *CIMETestSuite) TestGuangdong() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"cap\":\"30.00\",\"fts\":1697068800000,\"id\":\"1\",\"ns\":\"#\",\"power\":\"0.00\",\"ts\":1697068800000}",
...
func (s *CIMETestSuite) TestHenan() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"code\":\"HNP\",\"fts\":1361984400000,\"id\":\"#1\",\"offset\":\"1\",\"ts\":1361984400000,\"value\":\"14.82\"}",
...
func (s *CIMETestSuite) TestHubei() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"fts\":1702685700000,\"id\":\"#1\",\"power\":\"162.24\",\"ts\":1702685700000}",
