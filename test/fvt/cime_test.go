...
func (s *CIMETestSuite) TestGuangdong() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"cap\":\"30.00\",\"id\":\"1\",\"ns\":\"#\",\"power\":\"0.00\",\"ts\":1697040000000}",
			"{\"cap\":\"30.00\",\"id\":\"2\",\"ns\":\"#\",\"power\":\"0.00\",\"ts\":1697040900000}",
			"{\"cap\":\"30.00\",\"id\":\"3\",\"ns\":\"#\",\"power\":\"0.00\",\"ts\":1697041800000}",
		}
		s.Equal(exp, results)
	})
	/// clean up
...
func (s *CIMETestSuite) TestHenan() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"code\":\"HNP\",\"id\":\"#1\",\"offset\":\"1\",\"ts\":1361955600000,\"value\":\"14.82\"}",
			"{\"code\":\"HNP\",\"id\":\"#2\",\"offset\":\"2\",\"ts\":1361955660000,\"value\":\"14.82\"}",
			"{\"code\":\"HNP\",\"id\":\"#3\",\"offset\":\"3\",\"ts\":1361955720000,\"value\":\"14.82\"}",
		}
		s.Equal(exp, results)
	})
	/// clean up
...
func (s *CIMETestSuite) TestHubei() {
	...
	s.Run("check result", func() {
		exp := []string{
			"{\"id\":\"#1\",\"power\":\"162.24\",\"ts\":1702656900000}",
			"{\"id\":\"#2\",\"power\":\"150.86\",\"ts\":1702657800000}",
			"{\"id\":\"#3\",\"power\":\"140.30\",\"ts\":1702658700000}",
		}
		s.Equal(exp, results)
	})
	/// clean up
